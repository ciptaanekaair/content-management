...
<head>
  ...
  <style media="screen and (min-width:480px)">
    .moz-text-html .mj-column-per-66-66666666666666 {
      width: 66.66666666666666% !important;
      max-width: 66.66666666666666%;
    }
...
<body style="word-spacing:normal;background-color:#e5e7eb;">
  <div style="background-color:#e5e7eb;">
                ...
                <tbody>
                  <tr>
                    <td style="direction:ltr;font-size:0px;padding:20px 0;text-align:center;">
                      ...
                      <div class="mj-column-per-66-66666666666666 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:middle;width:100%;">
                            ...
                            <tr>
                              <td align="left" style="font-size:0px;padding:10px 25px;padding-top:0;padding-bottom:0px;word-break:break-word;">
                                <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:16px;font-weight:bolder;line-height:1;text-align:left;color:#1e3a8a;">
                                  <center>
                                    <img src="https://admin.filterpedia.co.id/storage/images/online_report.svg" width="50%" alt="FilterPedia.co.id"><br>
                                    FILTERPEDIA
                                  </center>
                                </div>
                              </td>
                ...
                <tbody>
                  <tr>
                    <td style="direction:ltr;font-size:0px;padding-bottom:20px;text-align:center;">
                      <!--[if mso | IE]><table role="presentation" border="0" cellpadding="0" cellspacing="0"><tr><td class="" style="vertical-align:middle;width:199.99999999999997px;" ><![endif]-->
                      <div class="mj-column-per-66-66666666666666 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:middle;width:100%;">
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:middle;background-color: #1e40af;margin:0;" width="100%">
                          <tbody>
                            <tr>
                              <td align="center" style="font-size:0px;padding-top:10px;padding-bottom:10px;word-break:break-word;">
                                <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:16px;line-height:1;text-align:center;color:#fff;font-weight:bolder;">
    ...
    <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:100%;margin:10px 0">
      <tbody>
        <tr>
          <td>
                            ...
                            <tbody>
                              <tr>
                                <td align="center" style="font-size:0px;padding:0 25px;padding-bottom:10px;word-break:break-word;">
                                  <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#45474e;">Hi <b>{{ auth()->user()->name }}</b>!</div>
                                </td>
                              </tr>
                              <tr>
                      ...
                      <td style="direction:ltr;font-size:0px;padding:10px 0;text-align:left;">
                        ...
                        <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:middle;width:100%;">
                          <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:middle;" width="100%">
                            <tbody>
                              <tr>
                                <td style="font-size:0px;padding:10px 25px;padding-bottom:10px;word-break:break-word;">
                                  <div style="margin-left: 10px; padding-top: -10px;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:16px;align-self:flex-start;display:inline-block;color:#45474e;">
                                    Items
                                  </div>
                                </td>
                              </tr>
                    ...
                    <td style="direction:ltr;font-size:0px;padding:20px 0;text-align:center;">
                                  ...
                                  <tbody>
                                    <tr>
                                      <td style="width:250px;" align="center">
                                        <img alt="" height="auto" src="{{ $item->products->image_url }}" style="border:0;border-radius:10px;outline:none;text-decoration:none;height:auto;width:80%;font-size:13px;" width="250" />
                                      </td>
                                    </tr>
                                  </tbody>
                                </table>
                      ...
                      <div class="mj-column-per-50 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:middle;width:100%;">
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:middle;" width="100%">
                          <tbody>
                            <tr>
                              <td align="left" style="font-size:0px;padding:10px 25px;padding-top:25px;padding-bottom:25px;word-break:break-word;">
                                <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:11px;line-height:1;text-align:left;color:#9da3a3;"><span style="font-weight: bold; font-size: 16px; color: #45474e">{{ $item->products->product_name }}</span><br/><div style="margin:8px 0;"></div>
                                  <span style="font-size:16px;color:#059669;padding:10px 0px;">Rp. {{ number_format($item->products->product_price) }}</span><br />
                                  <div style="margin:8px 0;"></div>
                                  <span style="font-size:16px;color:#6b7280;padding:10px 0px;">Jumlah: {{ $item->qty }}</span><br />
                                  <div style="margin:8px 0;"></div>
                                  <span style="font-size:16px;color:#6b7280;padding:10px 0px;">Amount: Rp.{{ number_format($item->products->product_price * $item->qty) }}</span>
                                </div>
                              </td>
                            </tr>
                          </tbody>
                            ...
                            <tr>
                              <td style="font-size:0px;padding:0px 25px;word-break:break-word;">
                                <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:11px;line-height:1;text-align:left;color:#9da3a3;">
                                  <span style="font-weight: bold; font-size: 16px; color: #45474e">
                                    Harga Total
                                  </span><br/>
                                  <div style="margin:8px 0;"></div>
                              </td>
    ...
    <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:100%;margin:0px;">
      <tbody>
        <tr>
          <td>
            <!--[if mso | IE]><table align="center" border="0" cellpadding="0" cellspacing="0" class="" style="width:600px;" width="600" ><tr><td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;"><![endif]-->
                ...
                <tbody>
                  <tr>
                    <td style="direction:ltr;padding:20px 0;text-align:center;">
                      <!--[if mso | IE]><table role="presentation" border="0" cellpadding="0" cellspacing="0"><tr><td class="" style="vertical-align:middle;width:600px;" ><![endif]-->
                      <div class="mj-column-per-100 mj-outlook-group-fix" style="text-align:left;direction:ltr;display:inline-block;vertical-align:middle;width:100%;">
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:middle;" width="100%">
                          <tbody>
                            <tr>
                            ...
                            <tr>
                              <td align="center" style="padding:10px 25px;padding-top:0px;padding-bottom:0px;word-break:break-word;">
                                <div style="padding:10px;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:14px;text-align:center;color:#45474e;">Kawasan Pergudangan Arcadia, Blok G18 No 1-3,<br />Jl. Daan Mogot, RT.005/RW.003, Batuceper, Kec. Batuceper.<br />Kota Tangerang, Banten - 15122
                                </div>
                              </td>
                            </tr>
                          </tbody>
