...
class CheckoutController extends Controller
{
    ...
    /**
     * Confirmation checkout sekaligus mengubah user profile. untuk alamat pengiriman (table: user_details).
     */ 
    ...
    /**
     * Validasikan voucher secara real time setelah kode di masukan. => reference see: Shopee.co.id
     */ 
